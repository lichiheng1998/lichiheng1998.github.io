const projects = {
    "arFinder": {
        ...
        "built-in to the ios devices to achieve location memorization without using GPS. " +
        "By storing the distance vectors between the items and a fixed reference point, " +
        "the location of the item can be visualized in real time images with AR technology.",
        tech: ["Swift", "VRKit"],
        isPhone: true,
        numSnap: 3,
    ...
    "angrySun": {
        ...
        "the characters in the game are animated with multiple tile animations.",
    ...
    "myClass": {
        ...
        "students could also submit remark request, give anonymous reviews of the course "+
